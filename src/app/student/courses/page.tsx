            ...
            <div className="space-y-10 pb-20">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                    <div className="space-y-4">
                        <h1 className="text-4xl font-black tracking-tight text-dark">My Courses</h1>
                        <p className="text-gray-400 font-bold uppercase tracking-[0.2em] text-[10px]">
                            Track your performance and attendance across all modules.
                        </p>
                    </div>
                    <Link
                        href="/student/join"
                    ...
                    >
                        <PlusCircle size={20} />
                        <span className="font-black uppercase tracking-widest text-xs">Join New Course</span>
                    </Link>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="py-40 text-center bg-white rounded-[4rem] border-2 border-dashed border-gray-100">
                        ...
                        <h3 className="text-2xl font-black text-dark mb-2">No courses joined</h3>
                        <p className="text-gray-300 font-bold uppercase tracking-widest text-[10px]">Enter a join code to get started.</p>
                    </div>
                ) : viewMode === 'grid' ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {filteredCourses.map(course => (
                            <Link
                                ...
                                className="group relative bg-white p-10 rounded-[3.5rem] border border-gray-100 hover:border-primary/20 hover:shadow-2xl hover:shadow-primary/5 transition-all flex flex-col justify-between overflow-hidden"
                            >
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 mt-4">
                                            ...
                                            <span className="text-[10px] font-black text-gray-300 uppercase tracking-widest">{course.lecturer.fullName}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="mt-12 pt-8 border-t border-gray-50 flex items-center justify-between">
                                    ...
                                    <div className="text-right">
                                        <p className="text-[9px] font-black text-gray-300 uppercase tracking-widest mb-1">Classes</p>
                                        <p className="font-black text-dark">{course._count.classes}</p>
                                    </div>
                                </div>
                            </Link>
                        ))}
                                ...
                                <div className="flex items-center gap-8">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-4 mt-1">
                                            <span className="text-[10px] font-bold text-gray-300 uppercase tracking-widest">{course.code}</span>
                                            <span className="w-1 h-1 bg-gray-100 rounded-full" />
                                            <span className="text-[10px] font-bold text-gray-300 uppercase tracking-widest">{course.lecturer.fullName}</span>
                                        </div>
                                    </div>
                                </div>
